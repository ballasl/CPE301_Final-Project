...
char* tempTemplate = "RX: Values received: x=%4.2f m/s^2 y=%4.2f m/s^2 z=%4.2f m/s^2\n";
...
void process_message(char *message) {
	...
	char printBuffer[64];
	memcpy(&acceleration, message, sizeof(acceleration));
